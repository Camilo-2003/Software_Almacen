...
<table>
     ...
     if ($novedades->num_rows > 0) {
      ...
      echo "<tr>
        ...
        <td class='acciones'>
          <a class='btn-editar' href='Editar_Novedad.php?id={$datos['id_novedad']}'>✏️Editar</a>
          <a class='btn-eliminar' href='Eliminar_Novedad.php?id={$datos['id_novedad']}' onclick='return confirmarEliminacion()'>🗑️Eliminar</a> 
        </td>
      </tr>";
     }
    }  else {
