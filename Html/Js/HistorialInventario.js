...
document.getElementById("busquedaMateriales").value = document.getElementById("busquedaMateriales").value.trim();
document.getElementById("busquedaEquipos").value = document.getElementById("busquedaEquipos").value.trim();

return true;
}


document.getElementById("busquedaMateriales").addEventListener("input", function(e) {
